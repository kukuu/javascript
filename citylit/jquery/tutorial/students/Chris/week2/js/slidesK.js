$(document).ready(function() {
	...
	//This is container for just slide boxes
	slides
	...
	// Set #slideInner width equal to toal width of all slides. The 2 properties
	...
	$('#slideshow')
		...
		// Create event listeners for .controls clicks. Note the continuous use of CSS classes. Here we use tertiary operator
		$('.control')
			.bind('click', function() {
